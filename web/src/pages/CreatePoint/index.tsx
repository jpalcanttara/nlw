...
// array ou objeto: informar o tipo da variável
...
const CreatePoint = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        const ufInitials = res.data.map((item) => item.sigla);
        setUfs(ufInitials);
      });
  }, []);
  ...
  function handleMapClick(event: LeafletMouseEvent) {
    setSelectedMap([event.latlng.lat, event.latlng.lng]);
  }
